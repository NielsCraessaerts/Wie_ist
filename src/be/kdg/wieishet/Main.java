...
public class Main extends Application{
    ...
    public void start(Stage mijnStage) throws FileNotFoundException {
        //<editor-fold desc="Hardcoded shit">
...
//
//        }
////        ToggleButton[] toggleButtons = new ToggleButton[24];
////        ImageView[] graphics = new ImageView[24];
////        ImageView defaultGraphic = new ImageView("/characters/character" +karakterid +".png");
////        ImageView selectedGraphic = new ImageView("selectedPicture.jpg");
////
////        for (int i = 0; i < toggleButtons.length; i++) {
////            toggleButtons[i] = new ToggleButton();
////            toggleButtons[i].setGraphic(defaultGraphic);
////            toggleButtons[i].setSelected(false);
////            int buttonNumber = i;
////            toggleButtons[i].setOnAction((ActionEvent e) -> {
////                if (toggleButtons[i].isSelected()) {
////                    toggleButtons[i].setGraphic(selectedGraphic);
////                } else {
////                    toggleButtons[i].setGraphic(defaultGraphic);
////                }
////            });
